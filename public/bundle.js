...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./assets/laststop.css */ 8);
	
	var React = __webpack_require__(/*! react */ 10);
	var ReactDOM = __webpack_require__(/*! react-dom */ 41);
	var App = __webpack_require__(/*! ./components/layout/App.jsx */ 175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./app.css */ 3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./menu.css */ 7);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 5)(content, {});
	if(content.locals) module.exports = content.locals;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./laststop.css */ 9);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 5)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./laststop.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./laststop.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 9 */
/*!***************************************************!*\
  !*** ./~/css-loader!./client/assets/laststop.css ***!
  \***************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".laststop-list {\n  clear: both; padding-top: 5px;}\n.laststop-stops {font-weight: bold;}\n.laststop {margin: 5px 0px;}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(/*! ./ReactInstrumentation */ 26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDebugTool = __webpack_require__(/*! ./ReactDebugTool */ 27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(/*! ./ReactInvalidSetStateWarningDevTool */ 28);
	var warning = __webpack_require__(/*! fbjs/lib/warning */ 19);
	...
	function inject() {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(/*! ./ReactDefaultPerf */ 163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_assign(SyntheticEvent.prototype, {
	  ...
	  destructor: function () {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var noop = __webpack_require__(/*! fbjs/lib/emptyFunction */ 20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 10);
	var View = __webpack_require__(/*! ../laststop/List.jsx */ 176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 10);
	var ReactDOM = __webpack_require__(/*! react-dom */ 41);
	var request = __webpack_require__(/*! superagent */ 177);
	...
	var List = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    request.get('http://last-stop.herokuapp.com/apis/stops').end(function (err, res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(/*! emitter */ 178);
	var reduce = __webpack_require__(/*! reduce */ 179);
